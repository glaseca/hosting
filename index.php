...
<html>
	<head>
		...
		<title>Cargador de ficheros de glaseca</title>		
	...
	<form name="subir_imagen" method="post" enctype="multipart/form-data">      
		<fieldset>
			<legend>Perfil del fichero</legend>
			<label for="file">Selecciona un fichero</label>
			<input type="file" name="imagen" id="file" />
			<input type="submit" name="botEnviarImagen" id="upload" value="Subir" />		
		</fieldset>
	</form>
	</div>
	<div id="flotanteizquierda">
		<img src="images/3pasos.png" width="60%" height="60%"/>
	</div>
...
<?php 
        ...
        if(isset($_POST["botEnviarImagen"])){
			...
			*/	
                    ...
                    if(array_search($extimagen['extension'],$ext)){                    
						...
						echo "<div style='font-size:10pt;float=left;'><br />Tu fichero (URL corta): <a href='$urlmin' target='_blank'>$urlmin</a><br /><br />";						
						echo "Tu fichero (URL servidor): <a href='$urlnueva' target='_blank'>$urlnueva</a></div><br /><br />";
						...
						<div id="flotantederecha">
							...
							<span class='st_facebook_large' displayText='Facebook' st_url="<?php echo $urlcompleta; ?>" st_title="He subido este fichero al hosting de @glaseca"></span>
							<span class='st_twitter_large' st_via='' displayText='Tweet' st_url="<?php echo $urlcompleta; ?>" st_title="He subido este fichero al hosting de @glaseca"></span>
							<span class='st_linkedin_large' st_summary='<?php echo $urlcompleta; ?>' displayText='LinkedIn' st_url="<?php echo $urlcompleta; ?>" st_title="He subido este fichero al hosting de @glaseca"></span>
							<?
						/*	if($extimagen['extension'] != "zip" && $extimagen['extension'] != "pdf" && $extimagen['extension'] != "swf" && $extimagen['extension'] != "zip" 
							...
							{
							?>
								<span class='st_pinterest_large' displayText='Pinterest' st_url="<?php echo $urlcompleta; ?>" st_title="He subido este fichero al hosting de @glaseca"></span>
							<?php
							}
						*/	?>
							<span class='st_evernote_large' displayText='Evernote' st_url="<?php echo $urlcompleta; ?>" st_title="He subido este fichero al hosting de @glaseca"></span>
							<span class='st_email_large' displayText='Email' st_url="<?php echo $urlcompleta; ?>" st_title="He subido este fichero al hosting de @glaseca""></span>
						</div>
						...
						<div id="flotantederecha">
							<?php
								...
								$EC_level='L';
								$margin='0';
								echo '<h3>C&oacute;digo QR: </h3><img class="qr" src="http://chart.apis.google.com/chart?chs='.$widthHeight.'x'.$widthHeight.'&cht=qr&chld='.$EC_level.'|'
   					...
   					<?php    				
                        ...
                        echo "No se permite subir archivos con la extensi&oacute;n que est&oacute;s utilizando.<br /><br /><br />";
                    }
                }
	...
	{
		?>
		<div id="flotantemuyabajo"><label>2012 &copy; glaseca | Todos los derechos reservados.</label></div></div><br /><br />
		<?php
	}
	else
	{
		?>
		<div id="flotanteabajo"><label>2012 &copy; glaseca | Todos los derechos reservados.</label></div></div><br /><br />	
		<?php
	}
	?>
